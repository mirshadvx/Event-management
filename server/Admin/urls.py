...
from .views import (
    ...
    UserBulkUpdateStatusView,
    CouponList,
    CouponDetail,
    CouponBulkUpdateStatus,
    BadgeListCreateView,
    BadgeDetailView,
    UserBadgeListView,
    RevenueDistributionListView,
    RevenueSummaryView,
    TransactionHistoryListView,
    RefundHistoryListView,
...
from .admin_subscription_views import (
    ...
    AdminRecentSubscriptions,
    AdminResetSubscriptionCounters,
)
...
urlpatterns = [
    ...
    path(
        ...
        OrganizerRequestList.as_view(),
        name="organizer-requests-list",
    ),
    path(
        "organizer/organizer-requests/<int:pk>/update_status/",
        OrganizerRequestUpdateStatus.as_view(),
        name="organizer-requests-update-status",
    ),
    path(
        "organizer/organizer-requests/bulk_update/",
        OrganizerRequestBulkUpdate.as_view(),
        name="organizer-requests-bulk-update",
    ),
    path(
        "organizer/organizer-requests/<int:pk>/user_details/",
        OrganizerRequestUserDetails.as_view(),
        name="organizer-requests-user-details",
    ),
    path("users/", UserListView.as_view(), name="user-list"),
    path(
        "users/<int:pk>/update_status/",
        UserUpdateStatusView.as_view(),
        name="user-update-status",
    ),
    path(
        "users/bulk_update/",
        UserBulkUpdateStatusView.as_view(),
    ...
    path(
        "coupons/bulk_update/",
        CouponBulkUpdateStatus.as_view(),
        name="coupon-bulk-update",
    ),
    # badge
    ...
    path(
        ...
        RevenueDistributionListView.as_view(),
        name="revenue-distribution-list",
    ),
    ...
    path(
        "subscriptions-users/<int:pk>/status/",
        UserSubscriptionStatus,
        name="Status-subscription-control",
    ),
    path(
        "subscriptions-analytics/",
        SubscriptionAnalytics.as_view(),
