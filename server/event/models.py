...
class Event(models.Model):
    ...
    cancel_ticket = models.BooleanField(default=False)
...
class TicketPurchase(models.Model):
    buyer = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="ticket_purchases"
    )
    event = models.ForeignKey(
        Event, on_delete=models.CASCADE, related_name="ticket_purchases"
    )
...
class LiveStream(models.Model):
    event = models.ForeignKey(
        Event, on_delete=models.CASCADE, related_name="live_streams"
    )
    room_id = models.CharField(max_length=100, unique=True)
    stream_status = models.CharField(
        max_length=20, choices=[("live", "Live"), ("ended", "Ended")], default="live"
    )
...
class Review(models.Model):
    ...
    event = models.ForeignKey(
        Event, on_delete=models.CASCADE, related_name="reviews", db_index=True
    )
    user = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="event_reviews", db_index=True
    )
