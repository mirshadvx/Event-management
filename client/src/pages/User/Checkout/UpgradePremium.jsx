  ...
  useEffect(() => {
    const fetchUpgradePlanData = async () => {
      try {
        ...
        setError(
          err?.response?.data?.message || "Failed to load upgrade plan data"
        );
      } finally {
        setLoading(false);
      }
        ...
        <div className="max-w-md w-full bg-indigo-900/40 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-indigo-700/30">
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg text-indigo-100 mb-6 text-center">
              Thank you for upgrading. Your Premium access has been successfully
              activated.
            </p>
                ...
                {upgradePlan && upgradePlan.extra_amount === 0 ? (
                  <div className="text-center">
                    <p className="text-green-400 mb-4">
                      Your upgrade to Premium is free! Click below to complete
                      the upgrade.
                    </p>
                    <button
