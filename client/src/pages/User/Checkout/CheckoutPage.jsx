...
const CheckoutForm = ({ handlePayment, total, eventTitle, setPaymentStatus, setCouponError }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.requires_action) {
                const { error: confirmError } = await stripe.confirmCardPayment(response.payment_intent_client_secret);
                if (confirmError) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div>
                <label className={cn("block text-sm font-medium mb-1", processing ? "text-gray-400" : "text-gray-700")}>
                    Card Number
                </label>
                <CardNumberElement
            ...
            {isBelowMinimum && <p className="text-red-600 text-sm">Amount must be at least ₹0.50</p>}
            <button
                type="submit"
...
function CheckoutPage() {
    ...
    const selectedTickets = useSelector((state) => state.tickets.selectedTickets[eventId] || {});
    ...
    const applyCoupon = async () => {
        ...
        try {
            ...
            setCouponApplied({ code: response.data.code, discount: response.data.discount });
            setCouponCode("");
        } catch (error) {
    ...
    const getTotalTicketsCount = () => Object.values(selectedTickets).reduce((sum, count) => sum + count, 0);

    if (loading) {
        return (
            <div className={cn("min-h-screen flex items-center justify-center", isDarkMode ? "bg-gray-900" : "bg-gray-50")}>
                <div className="flex flex-col items-center">
                    ...
                    ></div>
                    <p className={cn("font-medium", isDarkMode ? "text-gray-300" : "text-gray-700")}>Loading checkout...</p>
                </div>
            </div>
        );
    }
    ...
    if (!event) {
        return (
            <div className={cn("min-h-screen flex items-center justify-center", isDarkMode ? "bg-gray-900" : "bg-gray-50")}>
                ...
                >
                    <X size={48} className={cn("mx-auto mb-6", isDarkMode ? "text-red-400" : "text-red-500")} />
                    <h2 className="text-2xl font-bold mb-2">Event Not Found</h2>
                    <p className={cn("mb-6", isDarkMode ? "text-gray-400" : "text-gray-600")}>
        ...
        return (
            <div className={cn("min-h-screen flex items-center justify-center", isDarkMode ? "bg-gray-900" : "bg-gray-50")}>
                ...
                >
                    <ShoppingCart
                        size={48}
                        className={cn("mx-auto mb-6", isDarkMode ? "text-blue-400" : "text-blue-500")}
                    />
        ...
        return (
            <div className={cn("min-h-screen flex items-center justify-center", isDarkMode ? "bg-gray-900" : "bg-gray-50")}>
                ...
                >
                    <CheckCircle
                        size={40}
                        className={cn("mx-auto mb-3", isDarkMode ? "text-green-400" : "text-green-600")}
                    />
                    <p className={cn("text-lg font-bold", isDarkMode ? "text-green-300" : "text-green-800")}>
                        Payment Successful!
                    </p>
                    <p className={cn("mb-4", isDarkMode ? "text-green-400" : "text-green-700")}>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="hidden sm:flex items-center">
                                ...
                                <div className={cn("w-16 h-px mx-2", isDarkMode ? "bg-gray-700" : "bg-gray-300")}></div>
                                <div
                                    className={cn(
                                        "flex items-center",
                                        checkoutStep === 2
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center">
                                    <Lock size={16} className={cn(isDarkMode ? "text-green-400" : "text-green-600")} />
                                    <span
                                        className={cn(
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    {checkoutStep === 1 ? (
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="text-right">
                                                                        <p className="font-semibold">
                                                                            {count} × {formatINR(parseFloat(ticket.price))}
                                                                        </p>
                                                                        <p
                                                                            className={cn(
                                                                                isDarkMode
                                                                        ...
                                                                        >
                                                                            {formatINR(count * parseFloat(ticket.price))}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            );
                                                ...
                                                <div className="p-6">
                                                    ...
                                                    {couponApplied ? (
                                                        ...
                                                        <div className="flex gap-3">
                                                            ...
                                                            <button
                                                                onClick={applyCoupon}
                                                                disabled={!couponCode.trim() || processingCoupon}
                                                                className={cn(
                                        ...
                                        >
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                {paymentMethod === "wallet" && paymentStatus === "idle" && (
                                                    <motion.button
                                                        key="pay-button"
                                                        initial={{ opacity: 0 }}
                                                        animate={{ opacity: 1 }}
                            ...
                            <div className="lg:col-span-1">
                                ...
                                >
                                    <div className={cn("border-b p-6", isDarkMode ? "border-gray-700" : "border-gray-200")}>
                                    ...
                                    <div className="p-6">
                                        <div className="space-y-4">
                                            <div className="flex justify-between">
                                                ...
                                                <p className="font-medium">{formatINR(priceDetails.subtotal)}</p>
                                            </div>
                                            {couponApplied && (
                                                <div
                                                    className={cn(
                                            ...
                                            >
                                                <div className="flex justify-between">
                                                    ...
                                                    <p className="font-bold text-lg">{formatINR(priceDetails.total)}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        {paymentStatus === "error" && (
                                            ...
                                            >
                                                <div className="text-center py-4">
                                                    ...
                                                    <p className={cn("mb-4", isDarkMode ? "text-red-400" : "text-red-700")}>
                                                        {couponError || "Please try again or contact support."}
                                                    </p>
                                                    <button
                                    ...
                                    >
                                        ...
                                        >
                                            <Lock size={14} /> <p>All transactions are secure and encrypted.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
