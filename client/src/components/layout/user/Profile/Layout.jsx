        ...
        `}>
          <NavLink to="/" className="header-logo">
            <img 
              src="/logo.png" 
              alt="Logo" 
              className={`object-contain rounded-full ${isMobile ? 'h-10 w-10' : 'h-12 w-12'}`}
            />
          </NavLink>
            ...
            {navItems.map((item, index) => (
              <li key={index} className="relative group">
                ...
                >
                  ...
                  <span className={`transition-opacity duration-300 ${isCollapsed ? 'opacity-0 pointer-events-none' : ''}`}>
                    {item.label}
                  </span>
                </NavLink>
