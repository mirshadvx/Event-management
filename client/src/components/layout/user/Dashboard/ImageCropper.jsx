...
const ImageCropper = ({ image, onCropDone, onCropCancel }) => {
    ...
    const onMediaLoaded = useCallback(({ width, height, naturalWidth, naturalHeight }) => {
        ...
        <div className="relative w-full h-[500px] flex flex-col">
            ...
            >
              {aspectRatio === 3/5 ? "Portrait" : "Landscape"}
                    ...
                    <div className="space-x-2">
                        <Button type="button" onClick={onCropCancel} variant="outline" className="bg-gray-700 text-white">
                            Cancel
                        </Button>
                        <Button type="button" onClick={() => onCropDone(croppedArea)} className="bg-green-500 text-white">
                            Crop & Apply
                        </Button>
                    </div>
                </div>
