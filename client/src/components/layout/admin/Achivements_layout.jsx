...
const AchievementsLayout = () => {
  ...
  const fetchBadges = async () => {
    ...
    try {
      const params = {
        ...
        criteria_type:
          filters.criteriaType === "all" ? undefined : filters.criteriaType,
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      ...
      setBadges(
        badges.map((b) => (b.id === currentBadge.id ? response.data : b))
      );
      setIsEditDialogOpen(false);
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFilters({ ...filters, criteriaType: value })
                    }
                  >
