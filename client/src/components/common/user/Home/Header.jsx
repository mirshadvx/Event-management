...
import {
  ...
  removeListener,
  disconnectWebSocket,
} from "@/services/user/notification/webSocketManager";
          ...
          {isAuthenticated && isDesktop && (
            <>
              ...
              <div className="flex items-center gap-4">
                <FaUsersLine
                  className="text-white w-6 h-6 cursor-pointer hover:text-[#00FF82] transition-colors"
                ...
                <div className="relative notification-icon">
                  ...
                  >
                    <IoIosNotifications
                      className={`text-white w-6 h-6 hover:text-[#00FF82] transition-colors ${
                        notificationOpen ? "text-[#00FF82]" : ""
                      }`}
                    />
            ...
            <div className="p-4 flex flex-col h-full">
              ...
              <div className="mt-auto mb-6 space-y-4">
                <div
                  ...
                  onClick={() => handleNavigation("/search")}
                >
                  <FaUsersLine className="text-white w-6 h-6" />
                  <span className="text-white/90">Search Users</span>
                </div>
                <div
                  className="flex items-center gap-4 cursor-pointer"
                  onClick={() => {
