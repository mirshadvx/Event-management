    ...
    return (
        ...
        >
            <div className="relative">
                ...
                <div
                    className={`absolute left-0 right-0 bottom-0 bg-[#2A2A2A] transition-all duration-300 ease-in-out overflow-hidden rounded-t-3xl ${
                        isExpanded ? "h-[2/3]" : "h-0"
                    }`}
                >
                    <div className="p-4">
...
export default DraftedEventCard;
