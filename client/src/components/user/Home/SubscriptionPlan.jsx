...
const tiers = [
    {
        ...
        features: ["Conduct monthly below 10 events", "Join events monthly 5-10"],
        featured: false,
    },
    {
        name: "Premium",
        ...
        features: [
            "Unlimited contect events",
            "Unlimited join events",
            "Advanced analytics",
            "Anyone can message",
                ...
                {tiers.map((tier, tierIdx) => (
                    <div
                        ...
                        className={classNames(
                            tier.featured ? "relative bg-gray-900 shadow-2xl" : "bg-white/10 sm:mx-8 lg:mx-0",
                            tier.featured
                                ? ""
                                : tierIdx === 0
                    ...
                    >
                        <h3
                            id={tier.id}
                            className="text-base/7 font-semibold text-[#00FF85]"
                            // className={classNames(
