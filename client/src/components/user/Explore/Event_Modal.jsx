...
const Event_Modal = ({ id, onClose }) => {
    ...
    if (!event) {
        return (
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-5 z-50">
                <div className="text-white bg-red-600/80 px-4 py-2 rounded">Event not found</div>
            </div>
        );
    }
                    ...
                    <div className=" w-full flex flex-col justify-between h-full text-black">
                        <div>
                            <p className="flex items-center">
                                <FaHashtag />
                                <span className="pl-1 text-xl font-bold">{event.event_title}</span>
                            </p>
                            <p className="flex items-start gap-2">
                                <span className="font-medium text-md pl-4">{event.description}</span>
                            </p>
                ...
                <div className="w-1/2 flex flex-col h-full">
                    <div className="p-4 flex items-center border-b border-gray-700">
                        ...
                        <div className="flex-1 flex items-center gap-2">
                            ...
                            <span className="text-blue-400 hover:underline cursor-pointer">Connect</span>
                        </div>
                    </div>
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    <div className="w-8 h-8 rounded-full overflow-hidden">
                                        <img src={comment.profile_picture} alt="" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex-1">
